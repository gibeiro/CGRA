...
LightingScene.prototype.init = function(application) {
	...
	//Ponteiros do sMyClock lmaoooo
	/*this.hours = new MyClockHand(this, 1, 0);
	this.minutes = new MyClockHand(this, 1, 90);
	this.seconds = new MyClockHand(this, 1, 180);*/
...
LightingScene.prototype.display = function() {
	...
	//Ponteiros
	/*this.pushMatrix();
	this.translate(5, 5, 2);
	this.hours.display();
	this.popMatrix();

	this.pushMatrix();
	this.translate(5, 5.5, 2);
